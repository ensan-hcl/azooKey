...
struct FlickKeyboardView<Extension: ApplicationSpecificKeyboardViewExtension>: View {
    ...
    @MainActor private func keyView(h: Int, v: Int) -> FlickKeyView<Extension> {
        ...
        return FlickKeyView<Extension>(model: model, size: size, position: (x: h, y: v), suggestState: $suggestState)
    }
    ...
    private func suggestView(h: Int, v: Int, suggestType: FlickSuggestState.SuggestType) -> FlickSuggestView<Extension> {
        ...
        return FlickSuggestView<Extension>(model: model, tabDesign: tabDesign, size: size, suggestType: suggestType)
    }
