...
class Store{
    ...
    var typographyLetterSetting = SettingItemViewModel(SettingItem<Bool>(
        ...
        screenName: "装飾英字変換",
        description: "英字入力をした際、「𝕥𝕪𝕡𝕠𝕘𝕣𝕒𝕡𝕙𝕪」のような装飾字体を候補に表示します",
        defaultValue: true
    ))
    ...
    var wesJapCalenderSetting = SettingItemViewModel(SettingItem<Bool>(
        ...
        screenName: "西暦⇄和暦変換",
        description: "「2020ねん→令和2年」「れいわ2ねん→2020年」のように西暦と和暦を相互に変換して候補に表示します",
        defaultValue: true
    ))
    ...
    var unicodeCandidateSetting = SettingItemViewModel(SettingItem<Bool>(
        ...
        description: "「u3042→あ」のように、入力されたunicode番号に対応する文字に変換します。接頭辞にはu, u+, U, U+が使えます",
        defaultValue: true
    ))
